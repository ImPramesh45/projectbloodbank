        ...
        <thead>
          ...
          <tbody>
            <tr>
              ...
              <td><center>
                <?php
                $q=$db->query("SELECT * FROM stock_blood_list WHERE bgroup='A+'");
                echo $row=$q->rowcount();
                ?>
              </center></td>
            </tr>
            ...
            <tr>
              ...
              <td><center>
                <?php
                $q=$db->query("SELECT * FROM stock_blood_list WHERE bgroup='B+'");
                echo $row=$q->rowcount();
                ?>
              </center></td>
            </tr>
            ...
            <tr>
              ...
              <td><center>
                <?php
                $q=$db->query("SELECT * FROM stock_blood_list WHERE bgroup='AB+'");
                echo $row=$q->rowcount();
                ?>
              </center></td>
            </tr>
            ...
            <tr>
              ...
              <td><center>
                <?php
                $q=$db->query("SELECT * FROM stock_blood_list WHERE bgroup='O+'");
                echo $row=$q->rowcount();
                ?>
              </center></td>
            </tr>

...
<body>
    ...
    <h1><center>All Donations</center></h1>
            ...
            while($r1=$q->fetch(PDO::FETCH_OBJ))
            {
                ...
                <tbody>
                    <tr class="table-info">
                        ...
                        <td><center>
                        <form action="fail-donations.php" method="POST">
                          <button type="submit" name="failed" value="<?=$r1->id;?>" class="btn btn-danger">Failed</button>
                        </form></center>
                        </td>
                    </tr>
                </tbody>

                ...
                <div class="card-body p-4 p-md-3"  style="background: linear-gradient(to right, #283048, #859398);border-radius:15px">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-4">
                        ...
                        <div class="form-outline">
                          ...
                          <label class="form-label" for="fullname" style="font-weight:600">Full Name</label>
                        </div>
                    ...
                    <div class="mt-4 pt-2 text-center">
                      <input class="btn btn-danger btn-lg" type="submit" name="subb" value="Donate" style="width:60%; font-weight:600; font-size:24px; border-radius:20px"/>
                    </div>
                  ...
                  if (isset($_POST['subb']))
                  {
                      ...
                      $bgroup=$_POST['bgroup'];
                      $q=$db->prepare("INSERT INTO blood_donations(fullname,phone,username,donationdate,bgroup) VALUES(:fullname,:phone,:username,:donationdate,:bgroup); INSERT INTO all_time_donations(fullname,phone,username,donationdate,bgroup) VALUES(:fullname,:phone,:username,:donationdate,:bgroup)");
                      ...
                      if($q->execute())
                      {
                        echo("<script>window.location = 'don-submitted.php';</script>");
                      }
                      else
                      { 

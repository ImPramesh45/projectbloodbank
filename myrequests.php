    ...
    <div style="overflow-x:auto;">
      <table class="table table-striped table-dark" style="width:80%; margin:0% auto">
        <thead>
            ...
            <?php
            $q=$db->query("SELECT * FROM confirmed_blood_requests WHERE username='$username'");
            while($r1=$q->fetch(PDO::FETCH_OBJ))
            {
                ...
                <tbody>
                    <tr class="table-info">
                        ...
                        <td><center><button type="submit" name="" value="#" class="btn btn-danger">Confirmed</button></center></td>
                    </tr>
                </tbody>
                        <?php
            }
